...
class Administrator_Model extends CI_Model
{
	...
	public function get_quizs($id = FALSE, $limit = FALSE, $offset = FALSE)
	{
		if ($limit) {
	...
	{
		$query = $this->db->get_where('answers', array('qid' => $qid));
		return $query->result_array();
	}
	...
	public function update_quiz_data()
	{
		...
		$d = $this->db->update('quiz', $data);
	}

	public function update_answer_data()
	{
		$data = array(
			'answer' => $this->input->post('answer'),
			'isCorrect' => $this->input->post('isCorrect')
