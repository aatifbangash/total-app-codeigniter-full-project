   ...
   <div class="page-header">
       ...
       <div class="page-header-breadcrumb">
           <ul class="breadcrumb-title">
               ...
               <li class="breadcrumb-item"><a href="#!">Add Answer</a>
               </li>
           </ul>
       </div>
   </div>
           ...
           <div class="col-sm-12">
               ...
               <div class="card">
                   <div class="card-block">
                       <div class="col-sm-8">
                           <?php echo form_open_multipart('administrator/add_answer'); ?>
                           <input type="hidden" name="qid" class="form-control" value="<?php echo $qid; ?>">
                           <div class="form-group row">
                               <label class="col-sm-2 col-form-label">Answer</label>
                               <div class="col-sm-10">
                                   <input type="text" name="answer" class="form-control" value="" placeholder="Full Name">
                               </div>
                           </div>
